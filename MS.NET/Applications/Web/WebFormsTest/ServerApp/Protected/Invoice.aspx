<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Invoice.aspx.cs" Inherits="ServerApp.Protected.Invoice" %>
...
<body>
    <h1>Invoice of Customer <asp:Label ID="CustomerIdLabel" runat="server" /> </h1>
    <form id="form1" runat="server">
        <p>
            ...
            <asp:ObjectDataSource ID="InvoiceDataSource" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="ServerApp.Models.ShopDataSetTableAdapters.InvoiceTableAdapter">
                <SelectParameters>
